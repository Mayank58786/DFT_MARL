...
# Skip every 10th episode
episodes_to_plot = [ep for ep in episodes if ep % 10 != 0]

# Plot metrics for red agent
plt.figure(figsize=(12, 8))
plt.subplot(3, 2, 1)
plt.plot(episodes_to_plot, value_losses_red[::10], label='Value Loss')
plt.xlabel('Episodes')
...
plt.subplot(3, 2, 2)
plt.plot(episodes_to_plot, policy_losses_red[::10], label='Policy Loss')
plt.xlabel('Episodes')
...
plt.subplot(3, 2, 3)
plt.plot(episodes_to_plot, old_approx_kls_red[::10], label='Old Approx KL')
plt.xlabel('Episodes')
...
plt.subplot(3, 2, 4)
plt.plot(episodes_to_plot, approx_kls_red[::10], label='Approx KL')
plt.xlabel('Episodes')
...
plt.subplot(3, 2, 5)
plt.plot(episodes_to_plot, clip_fractions_red[::10], label='Clip Fraction')
plt.xlabel('Episodes')
...
plt.subplot(3, 2, 6)
plt.plot(episodes_to_plot, explained_variances_red[::10], label='Explained Variance')
plt.xlabel('Episodes')
...
plt.figure(figsize=(12, 8))
plt.subplot(3, 2, 1)
plt.plot(episodes_to_plot, value_losses_blue[::10], label='Value Loss')
plt.xlabel('Episodes')
plt.ylabel('Value Loss')
...
plt.subplot(3, 2, 2)
plt.plot(episodes_to_plot, policy_losses_blue[::10], label='Policy Loss')
plt.xlabel('Episodes')
plt.ylabel('Policy Loss')
...
plt.subplot(3, 2, 3)
plt.plot(episodes_to_plot, old_approx_kls_blue[::10], label='Old Approx KL')
plt.xlabel('Episodes')
plt.ylabel('Old Approx KL')
...
plt.subplot(3, 2, 4)
plt.plot(episodes_to_plot, approx_kls_blue[::10], label='Approx KL')
plt.xlabel('Episodes')
plt.ylabel('Approx KL')
...
plt.subplot(3, 2, 5)
plt.plot(episodes_to_plot, clip_fractions_blue[::10], label='Clip Fraction')
plt.xlabel('Episodes')
plt.ylabel('Clip Fraction')
...
plt.subplot(3, 2, 6)
plt.plot(episodes_to_plot, explained_variances_blue[::10], label='Explained Variance')
plt.xlabel('Episodes')
plt.ylabel('Explained Variance')
